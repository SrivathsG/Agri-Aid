        ...
        <div className='home'>
            <section className='h-screen min-h-screen'>
                <div className='home-container bg-cover bg-center bg-no-repeat h-full rounded-md p-10'>
                    <div className="container-full p-5 h-full  border-white border-4 rounded-xl">
                        <div className='flex justify-between h-full w-full '>
                            <div className='h-full w-1/3 bg-white rounded-xl p-5 flex flex-col gap-10'>
                                ...
                                <div className='flex flex-col justify-between flex-grow relative'>
                                    <p className='text-inter text-4xl font-light text-left'>Optimize your next crop cycle with us for better results!</p>
                                    <button className='rounded-2xl bg-sky-200 py-2 w-1/2 absolute right-0 bottom-10 '
                ...
                <div className='sm-container flex-shrink-0 rounded-md bg-sky-200 p-6 relative'>
                    <div className='h-full bg-white rounded-md flex justify-between flex-col'>
                        <div className="top-leftbox w-full relative">
                            <p className="absolute top-0 text-left  z-10 text-roboto text-3xl font-light leading-8 max-w-half">Why growing the right crop is important ?</p>
            ...
            <section className="h-screen flex container-full ">
                <div className="last-container flex gap-5 h-4/5 w-full overflow-hidden">
                    ...
                    <div className="rightside flex-grow flex flex-col gap-5">
                        <div className="top h-1/2 w-full bg-green-700 rounded-lg px-5 py-10">
                            <div className="flex flex-col h-full w-full justify-between">
                                <p className="text-left font-roboto font-weight-300 text-3xl leading-tight text-gray-200">
                                    No more issues! Get all your doubts and issues cleared with us
                                </p>
                                <button className="rounded-xl text-white text-center text-2xl leading-tight font-light w-1/2 bg-avocado py-2">
                                    Next Page &#8594;
                                </button>
                            </div>
                        </div>
                        <div className="down flex-grow bg-avocado rounded-lg relative px-4 py-3 ">
                            <div className="feedback-container flex flex-col gap-4 px-5  absolute bottom-1/4 right-5 items-end">
                                <p className='font-normal text-3xl text-right'>For Feedback</p>
                                <button className='font-normal  text-2xl rounded-xl text-white bg-green-700
